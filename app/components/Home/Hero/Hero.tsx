...
const Hero = () => {
  ...
  <ParticlesHero />
        ...
        <h1 className='text-2xl sm:text-4xl md:text-5xl lg:text-6xl mt-6 text-centre font-bold tracking-wide'>Creating web products,<br></br>brands,<span className='text-red-600'>  and experiences.</span>
           ...
           <h2 className='mt-5 text-sm px-2 text-center sm:text-2xl font-medium flex-medium flex items-center'>
           ...
           <button className='mt-6 px-10 py-4 bg-blue-800 hover:bg-blue-900 transition-all duration-300 cursor-pointer rounded text-lg font-medium'>
